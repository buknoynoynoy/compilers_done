...
public:
  ...
  int ival(){
    ...
    else {fatal("operand::ival: illegal operand type");return 0;}
  }
  float rval(){
    ...
    else {fatal("operand::rval: illegal operand type");return 0;}
  }
  string sval(){
    if (ot==id) {return varref->sval();}
    else {fatal("operand::sval: illegal operand type");return 0;}
  }
  // vvvvvvvvvvvvvvvvvvvvvvvv Statistics vvvvvvvvvvvvvvvvv
  void setFreeTime(int ft){
    switch (ot) {
